...
export class CartController {
  ...
  getCart(@Req() req: Request) {
    return this.cartService.getCart((req.user as any)['userId'])
  }
  ...
  addItem(@Req() req: Request, @Body() dto: AddToCartDto) {
    return this.cartService.addItem((req.user as any)['userId'], dto)
  }
  ...
  mergeCart(@Req() req: Request, @Body() dto: MergeCartDto) {
    return this.cartService.mergeCart((req.user as any)['userId'], dto)
  }
  ...
  updateItem(
    ...
    return this.cartService.updateItem((req.user as any)['userId'], itemId, dto)
  }
  ...
  clearCart(@Req() req: Request) {
    return this.cartService.clearCart((req.user as any)['userId'])
  }
  ...
  removeItem(@Req() req: Request, @Param('itemId') itemId: string) {
    return this.cartService.removeItem((req.user as any)['userId'], itemId)
  }
}